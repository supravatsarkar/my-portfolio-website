        ...
        <div className="container row m-0 mx-auto">
          ...
          <div className="mx-2 m-md-0 d-flex align-items-center justify-content-center col col-md-8 col-lg-6 box text-light ">
            <div className="">
              ...
              <h1 className="" data-aos="fade-up" data-aos-offset="10">
                I'm Supravat Sarkar
              </h1>
              <h3
                className=" "
              ...
              <p
                ...
                data-aos-offset="10"
              >
                I am a self taught Computer Programmer and MERN Stack Developer.
                Passionate about coding and also fell well to something in tech
                and fixed real world problems.
              </p>
              <div
                data-aos="zoom-in-up"
                data-aos-offset="0"
              ...
              <a
                href="https://drive.google.com/file/d/1749XAx7ydmb2SN_2MyWNhiTCjOcFg88Y/view?usp=sharing"
                target="_blank"
                rel="noreferrer"
              >
                <button
                  type="button"
                  className="btn btn btn-outline-warning mt-2"
                  data-aos="zoom-in-up"
                  data-aos-delay="600"
                  data-aos-offset="10"
                >
                  {" "}
                  <BsFillCloudArrowDownFill className="me-1" />
                  Download Resume
                </button>
              </a>
            </div>
